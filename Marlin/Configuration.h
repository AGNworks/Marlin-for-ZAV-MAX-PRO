...
#define CUSTOM_MACHINE_NAME "ZAV Printer"
...
#define TEMP_RESIDENCY_TIME         12  // (seconds) Time to wait for hotend to "settle" in M109
#define TEMP_WINDOW                  2  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_HYSTERESIS              5  // (°C) Temperature proximity considered "close enough" to the target

#define TEMP_BED_RESIDENCY_TIME     12  // (seconds) Time to wait for bed to "settle" in M190
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 190.32
  #define DEFAULT_bedKi 15.61
  #define DEFAULT_bedKd 580.02
...
#define USE_ZMIN_PLUG   //I use the top endstop of Z axe
//#define USE_IMIN_PLUG
//#define USE_JMIN_PLUG
//#define USE_KMIN_PLUG
//#define USE_XMAX_PLUG
#define USE_YMAX_PLUG       //I added this to have safety switch in the end of Y rails (2021.10.22)
//#define USE_ZMAX_PLUG     //Zav original endstop position
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1    //it was 1 but I want to use the endstop on the top
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
